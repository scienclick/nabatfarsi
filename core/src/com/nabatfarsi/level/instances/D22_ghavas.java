...
public class D22_ghavas extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D22_ghavas(AssetManager assetManager) {
    ...
    protected com.nabatfarsi.entity.Player[] GeneratePlayerArray(AssetManager assetManager) {
        com.nabatfarsi.entity.Player p1 = WordFactory.kooseh(gamePlayAtlas,assetManager);
               com.nabatfarsi.entity.Player p3 = WordFactory.mahi(gamePlayAtlas,assetManager);
        com.nabatfarsi.entity.Player p2 = WordFactory.ghavas(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D22_GHAVAS_X, com.nabatfarsi.config.DemoObsticlePositions.D22_GHAVAS_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D22_MAHI_X, com.nabatfarsi.config.DemoObsticlePositions.D22_MAHI_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D22_KOOSEH_X, com.nabatfarsi.config.DemoObsticlePositions.D22_KOOSEH_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_ghvas0);

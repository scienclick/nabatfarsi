...
public class D10_drkht extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.sanjab(gamePlayAtlas, assetManager);
        Player p1 = WordFactory.drkht(gamePlayAtlas, assetManager);
        Player p2 = WordFactory.fndgh(gamePlayAtlas, assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D10_DRAKHT_X, com.nabatfarsi.config.DemoObsticlePositions.D10_DRAKHT_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D10_SANJAB_X, com.nabatfarsi.config.DemoObsticlePositions.D10_SANJAB_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D10_FNDOQ_X, com.nabatfarsi.config.DemoObsticlePositions.D10_FNDOQ_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_drkht0);

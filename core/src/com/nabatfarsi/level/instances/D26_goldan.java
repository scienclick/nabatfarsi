...
public class D26_goldan extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D26_goldan(AssetManager assetManager) {
        gamePlayAtlas = assetManager.get(AssetDescriptors.GAME_PLAY_L26_GOLOLDAN);
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p1 = WordFactory.noor(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.baghcheh(gamePlayAtlas,assetManager);
        Player p3 = WordFactory.goldan(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D26_GLDAN_X, com.nabatfarsi.config.DemoObsticlePositions.D26_GLDAN_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D26_BAGHCHEH_X, com.nabatfarsi.config.DemoObsticlePositions.D26_BAGHCHEH_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D26_NOOR_X, com.nabatfarsi.config.DemoObsticlePositions.D26_NOOR_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_goldan0);

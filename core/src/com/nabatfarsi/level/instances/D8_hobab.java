...
public class D8_hobab extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D8_hobab(AssetManager assetManager) {
        gamePlayAtlas = assetManager.get(AssetDescriptors.GAME_PLAY_L8_HOBAB);
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p1 = WordFactory.asbabbazi(gamePlayAtlas, assetManager);
        Player p2 = WordFactory.hobab(gamePlayAtlas, assetManager);
        Player p3 = WordFactory.tv(gamePlayAtlas, assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D8_ASBABBAZI_X, com.nabatfarsi.config.DemoObsticlePositions.D8_ASBABBAZI_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D8_HOBAB_X, com.nabatfarsi.config.DemoObsticlePositions.D8_HOBAB_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D8_TV_X, com.nabatfarsi.config.DemoObsticlePositions.D8_TV_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_hobab0);

...
public class D14_jelle extends LevelBase {
    ...
    protected com.nabatfarsi.entity.Player[] GeneratePlayerArray(AssetManager assetManager) {
        com.nabatfarsi.entity.Player p2 = com.nabatfarsi.level.WordFactory.sib(gamePlayAtlas,assetManager);
               com.nabatfarsi.entity.Player p1 = com.nabatfarsi.level.WordFactory.moz(gamePlayAtlas,assetManager);
        com.nabatfarsi.entity.Player p3 = com.nabatfarsi.level.WordFactory.jele(gamePlayAtlas,assetManager);


        return new com.nabatfarsi.entity.Player[]{p1,
                p2,
                p3,
        };
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D14_JELE_X, com.nabatfarsi.config.DemoObsticlePositions.D14_JELE_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D14_MOZ_X, com.nabatfarsi.config.DemoObsticlePositions.D14_MOZ_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D14_SIB_X, com.nabatfarsi.config.DemoObsticlePositions.D14_SIB_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateEndScene(String regionname) {
        ...
        endScene.setSize(com.nabatfarsi.config.GameConfig.WORLD_WIDTH, com.nabatfarsi.config.GameConfig.WORLD_HEIGHT);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_jleh0);
        com.nabatfarsi.entity.CustomActor customActor = new com.nabatfarsi.entity.CustomActor(textureRegion);
        customActor.setSize(com.nabatfarsi.config.GameConfig.WORLD_WIDTH, com.nabatfarsi.config.GameConfig.WORLD_HEIGHT);

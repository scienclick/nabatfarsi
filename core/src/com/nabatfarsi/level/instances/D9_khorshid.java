...
public class D9_khorshid extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D9_khorshid(AssetManager assetManager) {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p1 = com.nabatfarsi.level.WordFactory.goosfand(gamePlayAtlas, assetManager);
        Player p3 = com.nabatfarsi.level.WordFactory.khorshid(gamePlayAtlas, assetManager);
        Player p2 = com.nabatfarsi.level.WordFactory.asman(gamePlayAtlas, assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D9_GOOSFAND_X, com.nabatfarsi.config.DemoObsticlePositions.D9_GOOSFAND_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D9_KHORSHID_X, com.nabatfarsi.config.DemoObsticlePositions.D9_KHORSHID_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D9_ASMAN_X, com.nabatfarsi.config.DemoObsticlePositions.D9_ASMAN_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_khorshid0);

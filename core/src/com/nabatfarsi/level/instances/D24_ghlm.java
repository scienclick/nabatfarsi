...
public class D24_ghlm extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p2 = WordFactory.daftar(gamePlayAtlas,assetManager);
               Player p1 = WordFactory.ktab(gamePlayAtlas,assetManager);
        Player p3 = WordFactory.ghlam(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager){
        ...
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D24_GHLM_X, com.nabatfarsi.config.DemoObsticlePositions.D24_GHLM_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D24_DAFTAR_X, com.nabatfarsi.config.DemoObsticlePositions.D24_DAFTAR_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D24_KETAB_X, com.nabatfarsi.config.DemoObsticlePositions.D24_KETAB_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_ghlm0);

...
public class D21_einak extends LevelBase {
    ...
    protected com.nabatfarsi.entity.Player[] GeneratePlayerArray(AssetManager assetManager) {
        com.nabatfarsi.entity.Player p3 = WordFactory.aroosak(gamePlayAtlas,assetManager);
        com.nabatfarsi.entity.Player p2 = WordFactory.sandali(gamePlayAtlas,assetManager);
        com.nabatfarsi.entity.Player p1 = WordFactory.einak(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager){
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D21_EINAK_X, com.nabatfarsi.config.DemoObsticlePositions.D21_EINAK_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D21_SANDALI_X, com.nabatfarsi.config.DemoObsticlePositions.D21_SANDALI_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D21_AROOSAK_X, com.nabatfarsi.config.DemoObsticlePositions.D21_AROOSAK_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager){
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_einak0);

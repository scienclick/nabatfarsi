...
public class D3_prvanh extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.roodkhaneh(gamePlayAtlas, assetManager);
        Player p2 = WordFactory.psr(gamePlayAtlas, assetManager);
        Player p1 = WordFactory.prvaneh(gamePlayAtlas, assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D3_ROODKHANEH_X, com.nabatfarsi.config.DemoObsticlePositions.D3_ROODKHANEH_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D3_PSR_X, com.nabatfarsi.config.DemoObsticlePositions.D3_PSR_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D3_PRVANEH_X, com.nabatfarsi.config.DemoObsticlePositions.D3_PRVANEH_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_prvanh0);

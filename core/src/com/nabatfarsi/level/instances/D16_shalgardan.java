...
public class D16_shalgardan extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D16_shalgardan(AssetManager assetManager) {
        gamePlayAtlas = assetManager.get(AssetDescriptors.GAME_PLAY_L16_SHALGARDN);
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.dastkesh(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.kolah(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.shalgardan(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(DemoObsticlePositions.D16_SHALGARDAN_X,DemoObsticlePositions.D16_SHALGARDAN_Y);
        o2.setPosition(DemoObsticlePositions.D16_KOLAH_X,DemoObsticlePositions.D16_KOLAH_Y);
        o3.setPosition(DemoObsticlePositions.D16_DASTKESH_X,DemoObsticlePositions.D16_DASTKESH_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_shalgardan0);

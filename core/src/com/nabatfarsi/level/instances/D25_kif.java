...
public class D25_kif extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.servis(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.mdrsh(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.kif(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D25_KIF_X, com.nabatfarsi.config.DemoObsticlePositions.D25_KIF_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D25_MADRESEH_X, com.nabatfarsi.config.DemoObsticlePositions.D25_MADRESEH_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D25_SERVIS_X, com.nabatfarsi.config.DemoObsticlePositions.D25_SERVIS_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_kif0);

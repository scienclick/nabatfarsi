...
public class D7_chtr extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D7_chtr(AssetManager assetManager) {
        gamePlayAtlas = assetManager.get(AssetDescriptors.GAME_PLAY_L7_CHTR);
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p1 = WordFactory.otobus(gamePlayAtlas, assetManager);
        Player p2 = WordFactory.khiaban(gamePlayAtlas, assetManager);
        Player p3 = WordFactory.chtr(gamePlayAtlas, assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D7_OTOBUS_X, com.nabatfarsi.config.DemoObsticlePositions.D7_OTOBUS_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D7_KHIABAN_X, com.nabatfarsi.config.DemoObsticlePositions.D7_KHIABAN_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D7_CHTR_X, com.nabatfarsi.config.DemoObsticlePositions.D7_CHTR_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_chtr0);

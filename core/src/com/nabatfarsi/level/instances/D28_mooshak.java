...
public class D28_mooshak extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D28_mooshak(AssetManager assetManager) {
        gamePlayAtlas = assetManager.get(AssetDescriptors.GAME_PLAY_L28_MOOSHAK);
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.nazdik(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.door(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.mooshak(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D28_MOOSHAK_X, com.nabatfarsi.config.DemoObsticlePositions.D28_MOOSHAK_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D28_DOOR_X, com.nabatfarsi.config.DemoObsticlePositions.D28_DOOR_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D28_NAZDIK_X, com.nabatfarsi.config.DemoObsticlePositions.D28_NAZDIK_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_mooshk0);

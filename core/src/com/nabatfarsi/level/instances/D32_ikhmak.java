...
public class D32_ikhmak extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D32_ikhmak(AssetManager assetManager) {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.abnabat(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.mghazeh(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.ikhmak(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D32_IKHMAK_X, com.nabatfarsi.config.DemoObsticlePositions.D32_IKHMAK_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D32_MGHAZEH_X, com.nabatfarsi.config.DemoObsticlePositions.D32_MGHAZEH_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D32_ABNABAT_X, com.nabatfarsi.config.DemoObsticlePositions.D32_ABNABAT_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_ikhmk0);

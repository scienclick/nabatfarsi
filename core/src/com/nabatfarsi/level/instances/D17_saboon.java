...
public class D17_saboon extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D17_saboon(AssetManager assetManager) {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.shlng(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.mashin(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.saboon(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D17_SABOON_X, com.nabatfarsi.config.DemoObsticlePositions.D17_SABOON_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D17_MASHIN_X, com.nabatfarsi.config.DemoObsticlePositions.D17_MASHIN_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D17_SHLANG_X, com.nabatfarsi.config.DemoObsticlePositions.D17_SHLANG_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_saboon0);

...
public class D2_baran extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p1 = WordFactory.raad(gamePlayAtlas, assetManager);
        Player p2 = WordFactory.abr(gamePlayAtlas, assetManager);
        Player p3 = WordFactory.baran(gamePlayAtlas, assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D2_BARAN_X, com.nabatfarsi.config.DemoObsticlePositions.D2_BARAN_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D2_ABR_X, com.nabatfarsi.config.DemoObsticlePositions.D2_ABR_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D2_RAAD_X, com.nabatfarsi.config.DemoObsticlePositions.D2_RAAD_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_baran0);

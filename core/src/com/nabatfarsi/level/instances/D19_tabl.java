...
public class D19_tabl extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D19_tabl(AssetManager assetManager) {
        gamePlayAtlas = assetManager.get(AssetDescriptors.GAME_PLAY_L19_TABL);
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.takht(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.soot(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.tabl(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D19_TABL_X, com.nabatfarsi.config.DemoObsticlePositions.D19_TABL_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D19_SOOT_X, com.nabatfarsi.config.DemoObsticlePositions.D19_SOOT_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D19_TAKHT_X, com.nabatfarsi.config.DemoObsticlePositions.D19_TAKHT_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_tabl0);

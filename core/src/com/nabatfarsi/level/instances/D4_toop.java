...
public class D4_toop extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = com.nabatfarsi.level.WordFactory.divar(gamePlayAtlas, assetManager);
        Player p1 = com.nabatfarsi.level.WordFactory.darvazeh(gamePlayAtlas, assetManager);
        Player p2 = com.nabatfarsi.level.WordFactory.toop(gamePlayAtlas, assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D4_DIVAR_X, com.nabatfarsi.config.DemoObsticlePositions.D4_DIVAR_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D4_DARVAZEH_X, com.nabatfarsi.config.DemoObsticlePositions.D4_DARVAZEH_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D4_TOOP_X, com.nabatfarsi.config.DemoObsticlePositions.D4_TOOP_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_toop0);

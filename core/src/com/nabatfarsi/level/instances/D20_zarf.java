...
public class D20_zarf extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.ghza(gamePlayAtlas,assetManager);
        Player p2 = WordFactory.sofreh(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.zarf(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D20_ZARF_X, com.nabatfarsi.config.DemoObsticlePositions.D20_ZARF_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D20_GHAZA_X, com.nabatfarsi.config.DemoObsticlePositions.D20_GHAZA_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D20_SOFREH_X, com.nabatfarsi.config.DemoObsticlePositions.D20_SOFREH_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_zrf0);

...
public class D18_zabt extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.kamputer(gamePlayAtlas,assetManager);
               Player p1 = WordFactory.moosiqi(gamePlayAtlas,assetManager);
        Player p2 = WordFactory.zabt(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D18_ZABT_X, com.nabatfarsi.config.DemoObsticlePositions.D18_ZABT_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D18_MOOSIQI_X, com.nabatfarsi.config.DemoObsticlePositions.D18_MOOSIQI_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D18_KAMPUTER_X, com.nabatfarsi.config.DemoObsticlePositions.D18_KAMPUTER_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_zabt0);

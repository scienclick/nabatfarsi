...
public class D12_rooznameh extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D12_rooznameh(AssetManager assetManager) {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.samavar(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.ghoori(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.rooznameh(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D12_ROOZNAMEH_X, com.nabatfarsi.config.DemoObsticlePositions.D12_ROOZNAMEH_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D12_GHOORI_X, com.nabatfarsi.config.DemoObsticlePositions.D12_GHOORI_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D12_SAMAVAR_X, com.nabatfarsi.config.DemoObsticlePositions.D12_SAMAVAR_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_rooznamh0);

...
public class D31_havapeima extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D31_havapeima(AssetManager assetManager) {
        gamePlayAtlas = assetManager.get(AssetDescriptors.GAME_PLAY_L31_HAVAPEIMA);
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.ghtar(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.keshti(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.havapeima(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D31_HVAPEIMA_X, com.nabatfarsi.config.DemoObsticlePositions.D31_HVAPEIMA_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D31_GHATAR_X, com.nabatfarsi.config.DemoObsticlePositions.D31_GHATAR_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D31_KESHTI_X, com.nabatfarsi.config.DemoObsticlePositions.D31_KESHTI_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_hvapeima0);
        ...
        customActor.setAnimation(new Animation(GameAnimationConfig.DEMO_LAG_TIME12, Actortextures));

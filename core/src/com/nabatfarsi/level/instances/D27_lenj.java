...
public class D27_lenj extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.morghdarya(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.dolfin(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.lenj(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D27_LENJ_X, com.nabatfarsi.config.DemoObsticlePositions.D27_LENJ_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D27_MORGHDARYA_X, com.nabatfarsi.config.DemoObsticlePositions.D27_MORGHDARYA_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D27_DOLFIN_X, com.nabatfarsi.config.DemoObsticlePositions.D27_DOLFIN_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_lnj0);

...
public class D5_sanieh extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p1 = WordFactory.daghighe(gamePlayAtlas, assetManager);
        Player p2 = WordFactory.saat(gamePlayAtlas, assetManager);
        Player p3 = WordFactory.sanieh(gamePlayAtlas, assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D5_DAGHIGHE_X, com.nabatfarsi.config.DemoObsticlePositions.D5_DAGHIGHE_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D5_SAAT_X, com.nabatfarsi.config.DemoObsticlePositions.D5_SAAT_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D5_SANIEH_X, com.nabatfarsi.config.DemoObsticlePositions.D5_SANIEH_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_sanieh0);
        ...
        TextureRegion[] Actortextures = new TextureRegion[]{
                ...
                gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_frame121),
                gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_frame122)
        };

...
public class D6_jaroo extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.jaroobarghi(gamePlayAtlas, assetManager);
        Player p1 = WordFactory.madar(gamePlayAtlas, assetManager);
        Player p2 = WordFactory.jaroo(gamePlayAtlas, assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D6_JAROOBARGHI_X, com.nabatfarsi.config.DemoObsticlePositions.D6_JAROOBARGHI_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D6_MADAR_X, com.nabatfarsi.config.DemoObsticlePositions.D6_MADAR_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D6_JAROO_X, com.nabatfarsi.config.DemoObsticlePositions.D6_JAROO_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_jaroo0);

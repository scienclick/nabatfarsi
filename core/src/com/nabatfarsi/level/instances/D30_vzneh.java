...
public class D30_vzneh extends LevelBase {
    ...
    protected com.nabatfarsi.entity.Player[] GeneratePlayerArray(AssetManager assetManager) {
        com.nabatfarsi.entity.Player p3 = com.nabatfarsi.level.WordFactory.sangin(gamePlayAtlas,assetManager);
               com.nabatfarsi.entity.Player p2 = com.nabatfarsi.level.WordFactory.sbk(gamePlayAtlas,assetManager);
        com.nabatfarsi.entity.Player p1 = com.nabatfarsi.level.WordFactory.vznh(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D30_VZNEH_X, com.nabatfarsi.config.DemoObsticlePositions.D30_VZNEH_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D30_SBK_X, com.nabatfarsi.config.DemoObsticlePositions.D30_SBK_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D30_SANGIN_X, com.nabatfarsi.config.DemoObsticlePositions.D30_SANGIN_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_vznh0);

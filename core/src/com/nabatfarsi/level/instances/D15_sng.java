...
public class D15_sng extends LevelBase {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p1 = WordFactory.gonjeshk(gamePlayAtlas,assetManager);
               Player p3 = WordFactory.choob(gamePlayAtlas,assetManager);
        Player p2 = WordFactory.sng(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D15_SNG_X, com.nabatfarsi.config.DemoObsticlePositions.D15_SNG_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D15_GONJESHK_X, com.nabatfarsi.config.DemoObsticlePositions.D15_GONJESHK_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D15_CHOOB_X, com.nabatfarsi.config.DemoObsticlePositions.D15_CHOOB_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_sng0);

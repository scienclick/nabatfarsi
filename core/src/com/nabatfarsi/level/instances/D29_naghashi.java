...
public class D29_naghashi extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D29_naghashi(AssetManager assetManager) {
        gamePlayAtlas = assetManager.get(AssetDescriptors.GAME_PLAY_L29_NAGHASHI);
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager){
        Player p3 = WordFactory.mdadrngi(gamePlayAtlas,assetManager);
               Player p1 = WordFactory.pakkon(gamePlayAtlas,assetManager);
        Player p2 = WordFactory.naghashi(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D29_NGHASHI_X, com.nabatfarsi.config.DemoObsticlePositions.D29_NGHASHI_Y);
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D29_PAKKON_X, com.nabatfarsi.config.DemoObsticlePositions.D29_PAKKON_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D1_MEDADRANGI_X, com.nabatfarsi.config.DemoObsticlePositions.D29_MEDADRANGI_Y);
    ...
    protected com.nabatfarsi.entity.CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(com.nabatfarsi.assets.RegionNames.PLAYER_i_nghashi0);

...
public class D23_fanoos extends LevelBase {
    private static TextureAtlas gamePlayAtlas;
    private static TextureAtlas gamePlayAtlas2;


    public D23_fanoos(AssetManager assetManager) {
    ...
    protected Player[] GeneratePlayerArray(AssetManager assetManager) {
        Player p3 = WordFactory.darya(gamePlayAtlas,assetManager);
               Player p2 = WordFactory.khoshki(gamePlayAtlas,assetManager);
        Player p1 = WordFactory.fanoos(gamePlayAtlas,assetManager);
    ...
    protected Obstacle[] GenerateObstacleArray(AssetManager assetManager) {
        ...
        o1.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D23_FANOOS_X, com.nabatfarsi.config.DemoObsticlePositions.D23_FANOOS_Y);
        o2.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D23_DARYA_X, com.nabatfarsi.config.DemoObsticlePositions.D23_DARYA_Y);
        o3.setPosition(com.nabatfarsi.config.DemoObsticlePositions.D23_KHOSHKI_X, com.nabatfarsi.config.DemoObsticlePositions.D23_KHOSHKI_Y);
    ...
    protected CustomActor GenerateAnimatedActor(AssetManager assetManager) {
        TextureRegion textureRegion = gamePlayAtlas.findRegion(RegionNames.PLAYER_i_fanoos0);
